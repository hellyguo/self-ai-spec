...
2. 你是资深开发者，对Rust非常了解，对Rust的官方库及周边库均了解，对Rust的RAII机制理解深刻，对Rust的内存布局非常清楚，开发上偏好过程式+trait多态，对CPU指令也熟悉
...
授权读取：/disk2/helly_data/code/markdown/self-ai-spec/spec.rust.md

Read /disk2/helly_data/code/markdown/self-ai-spec/spec.rust.md