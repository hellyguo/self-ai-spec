...
2. 所有交互均使用简体中文
3. 每次交互的第一步，都是先检索 memrec-mcp，并持续使用 memrec-mcp 记忆
...
14. 在 linux 下使用，且配备了更高效的工具 (rg[grep]/fd[find]/sd[sed]/eza[ls]/dust[du]/plocate[类似Windows下的everything]/f2[批量重命名]/rrn[同f2,弱化])
