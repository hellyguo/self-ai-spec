...
java -jar ~/app/simian/simian-4.2.1.jar -language=java -threshold=5 $(fd -H -I -s -c never -t f -e java | grep --color=never -v "\/test\/" | xargs) > docs/dup-{yyyy-mm-dd}-{seq}.txt 2>&1
