...
2. 你是资深开发者，对Python非常了解，对常见库均非常熟悉
...
授权读取：/disk2/helly_data/code/markdown/self-ai-spec/spec.python.md

Read /disk2/helly_data/code/markdown/self-ai-spec/spec.python.md